...
public final class CategoryItemBinding implements ViewBinding {
  ...
  private CategoryItemBinding(@NonNull ConstraintLayout rootView, @NonNull TextView categoryName) {
  ...
  public static CategoryItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CategoryItemBinding((ConstraintLayout) rootView, categoryName);
    }
